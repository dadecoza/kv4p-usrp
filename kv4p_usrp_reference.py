#!/usr/bin/env python3
"""Reference KV4P-HT to AllStar USRP bridge.

This intentionally readable Python implementation documents the proven wire
protocol and audio path.  It is a reference for the planned lightweight C
daemon, but is also usable as a bridge in its own right.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--allstar-host", required=True, help="AllStar Pi address")
